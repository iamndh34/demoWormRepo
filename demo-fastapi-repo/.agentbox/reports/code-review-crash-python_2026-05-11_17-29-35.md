# code-review-crash-python — saved by agentbox --save

Generated: 2026-05-11T10:30:16Z

**⚠ 62 issue trên 1 file — chủ yếu là crash/correctness bug có thể gãy ngay ở edge case, parse lỗi, hoặc deadlock**
...
### `crash_bugs_catalog.py` (62 issue)
